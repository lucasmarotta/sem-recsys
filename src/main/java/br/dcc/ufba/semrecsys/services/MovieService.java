...
public class MovieService 
{
	...
	public List<Movie> getMovies()
	{
		...
		Movie m1 = new Movie("The Girl with the Dragon Tattoo");
		m1.setDbPediaURI("http://dbpedia.org/resource/The_Girl_with_the_Dragon_Tattoo");
		...
		m2.setDbPediaURI("http://dbpedia.org/resource/The_Matrix");
		...
		Movie m3 = new Movie("The Adjustment Bureau");
		m3.setDbPediaURI("http://dbpedia.org/page/The_Adjustment_Bureau");
	...
	public Properties getResourceProperties(Movie movie)
	{
		...
		for (String token : movie.getTokens()) 
		{
